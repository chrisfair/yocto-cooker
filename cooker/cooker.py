...
class CookerCommands:
    ...
    def prepare_build_directory(self, build):
        ...
        CookerCall.os.file_write(file, '\tHALT,${TMPDIR},100M,1K \\')
        CookerCall.os.file_write(file, '\tHALT,${DL_DIR},100M,1K \\')
        CookerCall.os.file_write(file, '\tHALT,${SSTATE_DIR},100M,1K \\')
        CookerCall.os.file_write(file, '\tHALT,/tmp,10M,1K"')
